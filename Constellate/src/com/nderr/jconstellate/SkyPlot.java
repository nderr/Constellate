...
public class SkyPlot {
	...
	public static void main(String[] args) {
		...
		System.out.println("loaded " + cons.size() + " constellations");
		...
		System.out.println("pointed to FOV");
		...
		System.out.println("plotted FOV");
		...
		int d4 = (int) (t5 - t4);
		int d5 = (int) (t6 - t5);
		System.out.println("Loading stars: " + d1 + " ms");
		System.out.println("Loading constellations: " + d2 + " ms");
		System.out.println("Making sky: " + d3 + " ms");
		System.out.println("Pointing to sky: " + d4 + " ms");
		System.out.println("Plotting: " + d5 + " ms");
	}
	...
	class Screen extends JPanel {
		...
		private void doDrawing(Graphics g) {
	        ...
	        for (Constellation c : sky.getConstFOV()) {
	        	float[] coords = c.getLines(w,h);
	        	for (int i = 0; i < coords.length; i += 4) {
	        		int x1 = (int) coords[i];
	        		int y1 = (int) coords[i + 1];
	        		int x2 = (int) coords[i + 2];
	        		int y2 = (int) coords[i + 3];
